...
-- CREATE USER IF NOT EXISTS 'globaltrade_app'@'%'
--     IDENTIFIED BY '<local-secret>';
-- GRANT ALL PRIVILEGES ON globaltrade_logistics.*
--     TO 'globaltrade_app'@'%';
-- FLUSH PRIVILEGES;
...
CREATE TABLE IF NOT EXISTS auth_user_roles (
    ...
    CONSTRAINT fk_auth_roles_user
    FOREIGN KEY (username)
    REFERENCES auth_users (username)
    ON DELETE CASCADE,
...
VALUES
    ...
    (
        ...
        '68iLtMB8q/O22GUfM9soJGDR21gFUQQcQCqJszuyIIg=',
        'Z2xvYmFsdHJhZGUtY29vcmRpbmF0b3ItMjAyNg==',
        120000,
        1,
        0
    ),
    (
        'warehouse',
        'Warehouse Manager',
        'EFJhVfD01QO5X9KcmQ7gb2xQlExErpzHuQ7eb90RoQg=',
        'Z2xvYmFsdHJhZGUtd2FyZWhvdXNlLTIwMjY=',
        120000,
        1,
        0
    ),
    (
        'customs',
        'Customs Agent',
        'qjIq0w+vLkfu1NjhJ0D7uPlNy9oo3EUZimPKNPM7fSI=',
        'Z2xvYmFsdHJhZGUtY3VzdG9tcy0yMDI2',
        120000,
        1,
        0
    ),
    (
        ...
        'ln8ZUvPp3+jk4Z0VxOFEZSUUv7foh4fGVOdFizFex8k=',
        'Z2xvYmFsdHJhZGUtdmVuZG9yLTIwMjY=',
        120000,
        1,
        0
    ),
    (
        ...
        'hJRPd2GgOkQuJwWP6I34bVrEGEpW5LdX0rh/EKT6Guk=',
        'Z2xvYmFsdHJhZGUtY3VzdG9tZXItMjAyNg==',
        120000,
        1,
        0
    )
...
CREATE TABLE IF NOT EXISTS vendors (
    ...
    last_evaluated DATETIME(6) NOT NULL,
    version       BIGINT       NOT NULL DEFAULT 0,

    CONSTRAINT uk_vendors_vendor_code
    UNIQUE (vendor_code),
...
CREATE TABLE IF NOT EXISTS inventory_items (
    ...
    CONSTRAINT uk_inventory_sku_warehouse
...
CREATE TABLE IF NOT EXISTS shipments (
    ...
    customs_reference   VARCHAR(80)  NOT NULL,
    risk_score          INT          NOT NULL,
    estimated_delivery  DATETIME(6)  NOT NULL,
    created_at          DATETIME(6)  NOT NULL,
    last_updated        DATETIME(6)  NOT NULL,
    version             BIGINT       NOT NULL DEFAULT 0,

    CONSTRAINT uk_shipments_reference
    UNIQUE (reference),
...
CREATE TABLE IF NOT EXISTS performance_metrics (
    ...
    INDEX idx_performance_captured_at (captured_at),
